...
function examGroupCall() {
  ...
  $.ajax({
    async: false,
    url: "https://192.168.32.22:8443/admin/exam_mng_grp",
    type: "GET",
    dataType: "json",
...
function selectGrpChange() {
  ...
  var html = "";
  $.ajax({
    url: "https://192.168.32.22:8443/admin/exam_mng_grp/" + grpId,
    type: "GET",
    dataType: "json",
    success: function (response) {
      // // console.log(response);
...
function exam(exam_num) {
  ...
  $.ajax({
    url: "https://192.168.32.22:8443/admin/exam_call",
    type: "POST",
...
function popup_hint_popupStatus(num) {
  ...
  $.ajax({
    url: "https://192.168.32.22:8443/admin/get_hint_contents",
    type: "POST",
    dataType: "json",
    contentType: "application/json",
    data: JSON.stringify(jsonData),
...
function popup_mit_popupStatus() {
  ...
  var html;
  $.ajax({
    url: "https://192.168.32.22:8443/admin/get_tactics",
    type: "GET",
    dataType: "json",
    success: function (response) {
      // console.log(response);
...
function getMiterMatrixByGrpid() {
  ...
  $.ajax({
    url: "https://192.168.32.22:8443/admin/get_matrix",
    type: "POST",
    dataType: "json",
    contentType: "application/json",
    data: JSON.stringify(jsonData),
...
function test() {
  ...
  $.ajax({
    async: false,
    url: "https://192.168.32.22:8443/admin/uploadFile",
    type: "POST",
    data: formData,
    cache: false,
    contentType: false,
...
function updateHint() {
  ...
  $.ajax({
    url: "https://192.168.32.22:8443/admin/exam_id_get",
    type: "POST",
    dataType: "json",
    contentType: "application/json",
    data: JSON.stringify(jsonData),
...
function updateHintGo(examId, upload) {
  ...
  $.ajax({
    url: "https://192.168.32.22:8443/admin/hintUpdate",
    type: "PATCH",
    dataType: "json",
    contentType: "application/json",
    data: JSON.stringify(jsonData),
...
function onlyGetExamId() {
  ...
  $.ajax({
    async: false,
    url: "https://192.168.32.22:8443/admin/only_get_examid",
    type: "POST",
    dataType: "json",
    contentType: "application/json",
    data: JSON.stringify(jsonData),
...
function tacticsSave() {
  ...
  // console.log(jsonData);
  $.ajax({
    url: "https://192.168.32.22:8443/admin/update_tactic",
    type: "PATCH",
    dataType: "json",
    contentType: "application/json",
    data: JSON.stringify(jsonData),
...
function examFinalSave() {
  ...
  // console.log(jsonData);
  $.ajax({
    url: "https://192.168.32.22:8443/admin/exam_final_save",
    type: "PATCH",
    dataType: "json",
    contentType: "application/json",
    data: JSON.stringify(jsonData),
...
function getExamLength() {
  ...
  $.ajax({
    async: false,
    url: "https://192.168.32.22:8443/admin/get_exam_length/" + exam_grpid,
    type: "GET",
    dataType: "json",
    success: function (response) {
      // // console.log(response);
