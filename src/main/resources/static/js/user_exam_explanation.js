...
function insertUserTrainExamStat() {
  ...
  $.ajax({
    url: "http://192.168.32.25:8080/user/insert_train_exam_stat",
    type: "POST",
    dataType: "json",
...
function insertExamstatTeam() {
  ...
  $.ajax({
    url: "http://192.168.32.25:8080/user/insert_train_exam_team_stat",
    type: "POST",
    dataType: "json",
    contentType: "application/json",
    data: JSON.stringify(jsonData),
...
function insertExamResultAndTeam(examId) {
  ...
  $.ajax({
    url: "http://192.168.32.25:8080/user/insert_train_examresult_and_team",
    type: "POST",
    dataType: "json",
    contentType: "application/json",
    data: JSON.stringify(jsonData),
...
function getHintFunc(grpId, examId, hintDeduct) {
  ...
  $.ajax({
    url: "http://192.168.32.25:8080/user/using_hint",
    type: "POST",
    dataType: "json",
    contentType: "application/json",
    data: JSON.stringify(jsonData),
...
function getHint(examId, grpId) {
  ...
  $.ajax({
    url: "http://192.168.32.25:8080/user/get_hint",
    type: "POST",
    dataType: "json",
    contentType: "application/json",
    data: JSON.stringify(jsonData),
...
function downloadFile() {
  ...
  $.ajax({
    url: "http://192.168.32.25:8080/user/download?filename=" + filename,
    method: "GET",
    xhrFields: {
      responseType: "blob",
    },
...
function checkAnsBtnMulti(examId) {
  ...
  $.ajax({
    url: "http://192.168.32.25:8080/user/using_answer_multi",
    type: "POST",
    dataType: "json",
    contentType: "application/json",
    data: JSON.stringify(jsonData),
...
function checkAnsBtnShort(examId) {
  ...
  // // // console.log(jsonData);
  $.ajax({
    url: "http://192.168.32.25:8080/user/using_answer_short_form",
    type: "POST",
    dataType: "json",
    contentType: "application/json",
    data: JSON.stringify(jsonData),
...
function countAnsExamResultTeam() {
  ...
  $.ajax({
    url: "http://192.168.32.25:8080/user/count_ans_exam_result_team",
    type: "POST",
    dataType: "json",
    contentType: "application/json",
    data: JSON.stringify(jsonData),
...
function getTotalStatus(staticAllowSecans) {
  if (staticAllowSecans == 1) {
    ...
    $.ajax({
      url: "http://192.168.32.25:8080/user/get_total_status",
      type: "POST",
      dataType: "json",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
...
function submitExam() {
  ...
  $.ajax({
    async: false,
    url: "http://192.168.32.25:8080/user/update_submit",
    type: "POST",
    contentType: "application/json",
    dataType: "json",
    data: JSON.stringify(jsonData),
...
function endTimeUpdateTime() {
  ...
  // // // console.log(jsonData);
  $.ajax({
    url: "http://192.168.32.25:8080/user/end_time_update_time",
    type: "POST",
    contentType: "application/json",
    dataType: "json",
    data: JSON.stringify(jsonData),
