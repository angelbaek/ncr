...
function getTraining() {
  ...
  $.ajax({
    async: false,
    url: "http://10.30.11.57:8080/admin/mgmt",
    type: "GET",
    dataType: "json",
...
function trainingStart() {
  ...
  if (one == true) {
    ...
    $.ajax({
      url: "http://10.30.11.57:8080/admin/trainingStart",
      type: "PATCH",
...
function grpActive(trainingNumbers) {
  ...
  if (trainingNumbers == 1) {
    ...
    $.ajax({
      url: "http://10.30.11.57:8080/admin/gprAct",
      type: "POST",
      contentType: "application/json",
      dataType: "json",
      data: JSON.stringify(jsonData),
...
function trainingPause() {
  $.ajax({
    url: "http://10.30.11.57:8080/admin/trainingPause",
    type: "PATCH",
    contentType: "application/json",
    dataType: "json",
    success: function (response) {
...
function groupView() {
  ...
  $.ajax({
    url: "http://10.30.11.57:8080/admin/groupView",
    type: "GET",
    dataType: "json",
    success: function (response) {
      // // console.log(response);
...
function teamcodeView() {
  ...
  scrollPause();
  $.ajax({
    url: "http://10.30.11.57:8080/admin/teamcodeView",
    type: "GET",
    dataType: "json",
    success: function (response) {
      // // console.log(response);
...
function edit(editNum) {
  ...
  if (editNum == 1) {
    ...
    // // console.log(jsonData);
    $.ajax({
      url: "http://10.30.11.57:8080/admin/gpract_edit",
      type: "DELETE",
      contentType: "application/json",
      dataType: "json",
      data: JSON.stringify(jsonData),
...
function getTrainMgmt() {
  ...
  $.ajax({
    async: false,
    url: "http://10.30.11.57:8080/admin/get_train_mgmt",
    type: "GET",
    dataType: "json",
    success: function (response) {
