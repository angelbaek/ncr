...
function insertUserTrainExamStat() {
  ...
  $.ajax({
    url: "http://10.30.11.57:8080/admin/insert_train_exam_stat",
    type: "POST",
    dataType: "json",
...
function insertExamstatTeam() {
  ...
  $.ajax({
    url: "http://10.30.11.57:8080/admin/insert_train_exam_team_stat",
    type: "POST",
    dataType: "json",
    contentType: "application/json",
    data: JSON.stringify(jsonData),
...
function insertExamResultAndTeam(examId) {
  ...
  $.ajax({
    url: "http://10.30.11.57:8080/admin/insert_train_examresult_and_team",
    type: "POST",
    dataType: "json",
    contentType: "application/json",
    data: JSON.stringify(jsonData),
...
function getHintFunc(grpId, examId, hintDeduct) {
  ...
  $.ajax({
    url: "http://10.30.11.57:8080/admin/using_hint",
    type: "POST",
    dataType: "json",
    contentType: "application/json",
    data: JSON.stringify(jsonData),
...
function getHint(examId, grpId) {
  ...
  $.ajax({
    url: "http://10.30.11.57:8080/admin/get_hint",
    type: "POST",
    dataType: "json",
    contentType: "application/json",
    data: JSON.stringify(jsonData),
...
function downloadFile() {
  ...
  $.ajax({
    url: "http://10.30.11.57:8080/admin/download?filename=" + filename,
    method: "GET",
    xhrFields: {
      responseType: "blob",
    },
...
function checkAnsBtnMulti(examId) {
  ...
  $.ajax({
    url: "http://10.30.11.57:8080/admin/using_answer_multi",
    type: "POST",
    dataType: "json",
    contentType: "application/json",
    data: JSON.stringify(jsonData),
...
function checkAnsBtnShort(examId) {
  ...
  // // // console.log(jsonData);
  $.ajax({
    url: "http://10.30.11.57:8080/admin/using_answer_short_form",
    type: "POST",
    dataType: "json",
    contentType: "application/json",
    data: JSON.stringify(jsonData),
...
function countAnsExamResultTeam() {
  ...
  $.ajax({
    url: "http://10.30.11.57:8080/admin/count_ans_exam_result_team",
    type: "POST",
    dataType: "json",
    contentType: "application/json",
    data: JSON.stringify(jsonData),
...
function getTotalStatus(staticAllowSecans) {
  if (staticAllowSecans == 1) {
    ...
    $.ajax({
      url: "http://10.30.11.57:8080/admin/get_total_status",
      type: "POST",
      dataType: "json",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
...
function submitExam() {
  ...
  $.ajax({
    async: false,
    url: "http://10.30.11.57:8080/admin/update_submit",
    type: "POST",
    contentType: "application/json",
    dataType: "json",
    data: JSON.stringify(jsonData),
...
function checkSubmitExam() {
  ...
  $.ajax({
    async: false,
    url: "http://10.30.11.57:8080/admin/check_submit",
    type: "POST",
    contentType: "application/json",
    dataType: "json",
    data: JSON.stringify(jsonData),
...
function endTimeUpdateTime() {
  ...
  // // console.log(jsonData);
  $.ajax({
    url: "http://10.30.11.57:8080/admin/end_time_update_time",
    type: "POST",
    contentType: "application/json",
    dataType: "json",
    data: JSON.stringify(jsonData),
