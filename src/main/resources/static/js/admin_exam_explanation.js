...
function getExamGrpInfoByGrpName(grpName) {
  ...
  $.ajax({
    async: false,
    url: "http://192.168.32.25:8080/user/get_exam_grp_info/" + grpName,
    type: "GET",
    dataType: "json",
...
function searchMgmtState() {
  ...
  $.ajax({
    async: false,
    url: "http://192.168.32.25:8080/admin/exam_explanation",
    type: "GET",
    dataType: "json",
    success: function (response) {
      // // console.log(response);
...
function getStartExamAndGrp(grpname) {
  ...
  $.ajax({
    async: false,
    url: "http://192.168.32.25:8080/admin/exam_explanation_sel/" + grpname,
    type: "GET",
    dataType: "json",
    success: function (response) {
      // // // console.log(response);
...
function insertUserTrainExamStat() {
  ...
  $.ajax({
    url: "http://192.168.32.25:8080/admin/insert_train_exam_stat",
    type: "POST",
    dataType: "json",
...
function insertExamstatTeam() {
  ...
  $.ajax({
    url: "http://192.168.32.25:8080/admin/insert_train_exam_team_stat",
    type: "POST",
    dataType: "json",
    contentType: "application/json",
    data: JSON.stringify(jsonData),
...
function insertExamResultAndTeam(examId) {
  ...
  $.ajax({
    url: "http://192.168.32.25:8080/admin/insert_train_examresult_and_team",
    type: "POST",
    dataType: "json",
    contentType: "application/json",
    data: JSON.stringify(jsonData),
...
function getHintFunc(grpId, examId, hintDeduct) {
  ...
  $.ajax({
    url: "http://192.168.32.25:8080/admin/using_hint",
    type: "POST",
    dataType: "json",
    contentType: "application/json",
    data: JSON.stringify(jsonData),
...
function getHint(examId, grpId) {
  ...
  $.ajax({
    url: "http://192.168.32.25:8080/admin/get_hint",
    type: "POST",
    dataType: "json",
    contentType: "application/json",
    data: JSON.stringify(jsonData),
...
function downloadFile() {
  ...
  $.ajax({
    url: "http://192.168.32.25:8080/admin/download?filename=" + filename,
    method: "GET",
    xhrFields: {
      responseType: "blob",
    },
...
function checkAnsBtnMulti(examId) {
  ...
  $.ajax({
    url: "http://192.168.32.25:8080/admin/using_answer_multi",
    type: "POST",
    dataType: "json",
    contentType: "application/json",
    data: JSON.stringify(jsonData),
...
function checkAnsBtnShort(examId) {
  ...
  // // // console.log(jsonData);
  $.ajax({
    url: "http://192.168.32.25:8080/admin/using_answer_short_form",
    type: "POST",
    dataType: "json",
    contentType: "application/json",
    data: JSON.stringify(jsonData),
...
function getExamTypeByExamId(examId) {
  ...
  $.ajax({
    async: false,
    url: "http://192.168.32.25:8080/user/get_exam_type_by_exam_id/" + examId,
    type: "GET",
    dataType: "json",
    success: function (response) {
      // // console.log(response);
...
function clientViewUpdate() {
  ...
  // // // console.log(jsonData);
  $.ajax({
    url: "http://192.168.32.25:8080/user/get_exam_result_team",
    type: "POST",
    dataType: "json",
    contentType: "application/json",
    data: JSON.stringify(jsonData),
...
function startTrainingGetTime() {
  ...
  $.ajax({
    async: false,
    url: "http://192.168.32.25:8080/user/get_start_training_get_time",
    type: "POST",
    dataType: "json",
    contentType: "application/json",
    data: JSON.stringify(jsonData),
...
function countAnsExamResultTeam() {
  ...
  $.ajax({
    url: "http://192.168.32.25:8080/admin/count_ans_exam_result_team",
    type: "POST",
    dataType: "json",
    contentType: "application/json",
    data: JSON.stringify(jsonData),
...
function getTotalStatus(staticAllowSecans) {
  if (staticAllowSecans == 1) {
    ...
    $.ajax({
      url: "http://192.168.32.25:8080/admin/get_total_status",
      type: "POST",
      dataType: "json",
      contentType: "application/json",
      data: JSON.stringify(jsonData),
...
function submitExam() {
  ...
  $.ajax({
    async: false,
    url: "http://192.168.32.25:8080/admin/update_submit",
    type: "POST",
    contentType: "application/json",
    dataType: "json",
    data: JSON.stringify(jsonData),
...
function checkSubmitExam() {
  ...
  $.ajax({
    async: false,
    url: "http://192.168.32.25:8080/admin/check_submit",
    type: "POST",
    contentType: "application/json",
    dataType: "json",
    data: JSON.stringify(jsonData),
...
//   $.ajax({
//     async: false,
//     url: "http://192.168.32.25:8080/user/check_submit",
//     type: "POST",
//     contentType: "application/json",
//     dataType: "json",
//     data: JSON.stringify(jsonData),
...
function endTimeUpdateTime() {
  ...
  // // console.log(jsonData);
  $.ajax({
    url: "http://192.168.32.25:8080/admin/end_time_update_time",
    type: "POST",
    contentType: "application/json",
    dataType: "json",
    data: JSON.stringify(jsonData),
...
function getMgMtState() {
  ...
  $.ajax({
    async: false,
    url: "http://192.168.32.25:8080/user/get_mgmt_state",
    type: "POST",
    contentType: "application/json",
    dataType: "json",
    data: JSON.stringify(jsonData),
