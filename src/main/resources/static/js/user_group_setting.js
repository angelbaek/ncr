...
function getGroupInfoById() {
  $.ajax({
    async: false,
    url: "http://10.30.11.57:8080/user/get_group_info_by_id",
    type: "GET",
    dataType: "json",
...
function getTeamGroup() {
  ...
  $.ajax({
    async: false,
    url: "http://10.30.11.57:8080/userGRP",
    type: "GET",
    dataType: "json",
    success: function (response) {
      // // console.log(response);
...
function userGroupSave() {
  ...
  $.ajax({
    url: "http://10.30.11.57:8080/user/update",
    type: "PATCH",
...
function training() {
  ...
  // // console.log(tr_user_grp);
  $.ajax({
    url: "http://10.30.11.57:8080/user/training/" + num,
    type: "GET",
    dataType: "json",
    success: function (response) {
      // console.log(response);
...
function getTrainingState() {
  var num = $("select[name=location_num]").val();
  $.ajax({
    url: "http://10.30.11.57:8080/user/get_training_state/" + num,
    type: "GET",
    dataType: "json",
    success: function (response) {
      // // console.log(response);
...
function getTrainingStateActiveOn() {
  $.ajax({
    url: "http://10.30.11.57:8080/user/get_training_state_active_on",
    type: "GET",
    dataType: "json",
    success: function (response) {
      // // console.log(response);
