...
function getExamResultByNumAndType(num, type, grpId) {
  ...
  $.ajax({
    async: false,
    url: "http://10.30.11.57:8080/user/get_exam_result_by_num_and_type",
    type: "POST",
    dataType: "json",
...
function getTotalTime(grpid) {
  ...
  $.ajax({
    async: false,
    url: "http://10.30.11.57:8080/user/static/get_time/" + grpid,
    type: "GET",
    dataType: "json",
    contentType: "application/json",
    success: function (response) {
...
function getGrpid() {
  ...
  $.ajax({
    async: false,
    url: "http://10.30.11.57:8080/user/static/get_grpid",
    type: "GET",
    dataType: "json",
    contentType: "application/json",
    success: function (response) {
...
function getUserExamStat(statId, grp, num, grpId) {
  ...
  $.ajax({
    url: "http://10.30.11.57:8080/user/get_user_exam_stat",
    type: "POST",
    dataType: "json",
    contentType: "application/json",
    data: JSON.stringify(jsonData),
...
function getExamResultTeam(statId, num, grpId, grp) {
  ...
  $.ajax({
    url: "http://10.30.11.57:8080/user/static/get_exam_result_team",
    type: "POST",
    dataType: "json",
    contentType: "application/json",
    data: JSON.stringify(jsonData),
...
function getExamStat(statId, num, grpId, grp) {
  ...
  $.ajax({
    url: "http://10.30.11.57:8080/user/static/get_exam_stat",
    type: "POST",
    dataType: "json",
    contentType: "application/json",
    data: JSON.stringify(jsonData),
...
function getExamStatTeam(num, grpId, grp) {
  ...
  // console.log(jsonData);
  $.ajax({
    url: "http://10.30.11.57:8080/user/static/get_exam_stat_team",
    type: "POST",
    dataType: "json",
    contentType: "application/json",
    data: JSON.stringify(jsonData),
...
function popUpFalseToTrue(grp, num, grpId, examId, ansTrue) {
  ...
  $.ajax({
    url: "http://10.30.11.57:8080/user/static/get_select_detail",
    type: "POST",
    dataType: "json",
    contentType: "application/json",
    data: JSON.stringify(jsonData),
...
function falseToTrue(grp, num, grpId, examId) {
  ...
  $.ajax({
    async: false,
    url: "http://10.30.11.57:8080/user/static/false_change_true",
    type: "POST",
    dataType: "json",
    contentType: "application/json",
    data: JSON.stringify(jsonData),
...
function getMatrixStat(grpid, grp, num) {
  ...
  $.ajax({
    async: false,
    url: "http://10.30.11.57:8080/user/static/get_matrix_stat",
    type: "POST",
    dataType: "json",
    contentType: "application/json",
    data: JSON.stringify(jsonData),
...
function getMiterAttackMatrix(grpid, grp, num) {
  ...
  $.ajax({
    async: false,
    url: "http://10.30.11.57:8080/user/static/get_matrix",
    type: "POST",
    dataType: "json",
    contentType: "application/json",
    data: JSON.stringify(jsonData),
...
function popUp(MA_TACTICS_ID, MA_MATRIX_ID) {
  ...
  $.ajax({
    async: false,
    url: "http://10.30.11.57:8080/user/get_tech_and_mit",
    type: "POST",
    dataType: "json",
    contentType: "application/json",
    data: JSON.stringify(jsonData),
...
function selectUserOrgByUserId(id) {
  ...
  $.ajax({
    async: false,
    url: "http://10.30.11.57:8080/user/select_user_org_by_user_id",
    type: "POST",
    dataType: "json",
    contentType: "application/json",
    data: JSON.stringify(jsonData),
...
function getTeamOrg(num, grpId, grp) {
  ...
  $.ajax({
    async: false,
    url: "http://10.30.11.57:8080/user/static/get_org",
    type: "POST",
    dataType: "json",
    contentType: "application/json",
    data: JSON.stringify(jsonData),
